package com.gios.light.common.theme
 ...
 * something else should use something else, and several do — LightGlance runs a lighter [Dim]
 * because its whole surface is dimmer. Constants are easier to disagree with than a theme.
 */
