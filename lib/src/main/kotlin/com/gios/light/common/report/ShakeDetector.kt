...
class ShakeDetector(context: Context, private val onShake: () -> Unit) : SensorEventListener {
    ...
    private companion object {
        /** How long a peak stays on the readout. Long enough to look down and read it. */
    ...
    override fun onSensorChanged(event: SensorEvent) {
        ...
        // Nothing is looking at the numbers, so do not compute or publish them. The detector
        // runs at 50Hz for as long as the app is in front, and pushing every one of those
        // samples into a flow with no collector is pure waste.
        ...
        // Every third sample is about 16Hz — faster than anyone can read, and a third of the
        // recompositions.
