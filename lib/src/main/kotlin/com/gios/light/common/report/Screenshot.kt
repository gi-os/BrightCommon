 ...
 *
 * Ported unchanged in behaviour from Roll, which is where it was written and where it stayed —
 * and the reason three apps could not move onto this library until now. A report with a picture
 * of the wrong-looking screen is a different class of report: "LOOKS OFF" and a screenshot is
 * actionable, "LOOKS OFF" alone is a shrug.
 *
...
object Screenshot {
    ...
    private fun shrink(source: Bitmap, width: Int): ByteArray? = runCatching {
        ...
        val paint = Paint(Paint.FILTER_BITMAP_FLAG).apply {
            ...
            // nothing here. Several of these apps can put the phone into colour mode, so this
            // is not theoretical.
